...
# Form implementation generated from reading ui file 'eric\Plugins\VcsPlugins\vcsMercurial\ConfigurationPage\MercurialPage.ui'
#
...
class Ui_MercurialPage(object):
    def setupUi(self, MercurialPage):
        ...
        self.groupBox_3 = QtWidgets.QGroupBox(MercurialPage)
        self.groupBox_3.setObjectName("groupBox_3")
        self.verticalLayout = QtWidgets.QVBoxLayout(self.groupBox_3)
        self.verticalLayout.setObjectName("verticalLayout")
        self.logBrowserCheckBox = QtWidgets.QCheckBox(self.groupBox_3)
        self.logBrowserCheckBox.setObjectName("logBrowserCheckBox")
        self.verticalLayout.addWidget(self.logBrowserCheckBox)
        ...
        MercurialPage.setTabOrder(self.logSpinBox, self.commitSpinBox)
        MercurialPage.setTabOrder(self.commitSpinBox, self.logBrowserCheckBox)
        MercurialPage.setTabOrder(self.logBrowserCheckBox, self.pullUpdateCheckBox)
    ...
    def retranslateUi(self, MercurialPage):
        ...
        self.groupBox_3.setTitle(_translate("MercurialPage", "Incoming / Outgoing"))
        self.logBrowserCheckBox.setToolTip(_translate("MercurialPage", "Select to show the incoming and outgoing log in a log browser dialog"))
        self.logBrowserCheckBox.setText(_translate("MercurialPage", "Use Log Browser for incoming / outgoing log"))
