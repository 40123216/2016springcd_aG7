...
# Form implementation generated from reading ui file 'eric\Plugins\VcsPlugins\vcsMercurial\HgTagDialog.ui'
#
...
class Ui_HgTagDialog(object):
    def setupUi(self, HgTagDialog):
        ...
        self.gridLayout.addWidget(self.tagTypeGroup, 3, 0, 1, 2)
        ...
        HgTagDialog.setTabOrder(self.deleteTagButton, self.globalTagButton)
        HgTagDialog.setTabOrder(self.globalTagButton, self.localTagButton)
        HgTagDialog.setTabOrder(self.localTagButton, self.buttonBox)
