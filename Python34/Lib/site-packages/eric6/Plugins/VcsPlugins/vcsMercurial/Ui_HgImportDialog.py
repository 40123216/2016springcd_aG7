...
# Form implementation generated from reading ui file 'eric\Plugins\VcsPlugins\vcsMercurial\HgImportDialog.ui'
#
...
class Ui_HgImportDialog(object):
    def setupUi(self, HgImportDialog):
        ...
        self.patchFileEdit = QtWidgets.QLineEdit(HgImportDialog)
        self.patchFileEdit.setObjectName("patchFileEdit")
        self.horizontalLayout_2.addWidget(self.patchFileEdit)
        self.patchFileButton = QtWidgets.QToolButton(HgImportDialog)
        self.patchFileButton.setObjectName("patchFileButton")
        self.horizontalLayout_2.addWidget(self.patchFileButton)
        ...
        HgImportDialog.setTabOrder(self.stripSpinBox, self.patchFileEdit)
        HgImportDialog.setTabOrder(self.patchFileEdit, self.patchFileButton)
        HgImportDialog.setTabOrder(self.patchFileButton, self.forceCheckBox)
        HgImportDialog.setTabOrder(self.forceCheckBox, self.buttonBox)
    ...
    def retranslateUi(self, HgImportDialog):
        ...
        self.patchFileEdit.setToolTip(_translate("HgImportDialog", "Enter the name of the patch file"))
        self.patchFileButton.setToolTip(_translate("HgImportDialog", "Press to select the patch file via a file selection dialog"))
