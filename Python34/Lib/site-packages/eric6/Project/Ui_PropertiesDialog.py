...
class Ui_PropertiesDialog(object):
    def setupUi(self, PropertiesDialog):
        ...
        self.dirEdit = QtWidgets.QLineEdit(PropertiesDialog)
        ...
        self.mainscriptEdit = QtWidgets.QLineEdit(PropertiesDialog)
        self.mainscriptEdit.setObjectName("mainscriptEdit")
        ...
        self.dirButton = QtWidgets.QToolButton(PropertiesDialog)
        self.dirButton.setObjectName("dirButton")
        self.gridLayout.addWidget(self.dirButton, 5, 2, 1, 1)
        self.mainscriptButton = QtWidgets.QToolButton(PropertiesDialog)
        ...
        self._2.setContentsMargins(6, 6, 6, 6)
...
"<p>Enter the project name</p>"))
        ...
        self.dirEdit.setToolTip(_translate("PropertiesDialog", "Enter the project directory"))
...
"<p>Enter the version no.</p>"))
        ...
        self.mainscriptEdit.setToolTip(_translate("PropertiesDialog", "Enter the main script"))
...
"<p>Enter a short description for the project.</p>"))
        self.dirButton.setToolTip(_translate("PropertiesDialog", "Show directory selection dialog"))
...
"<p>Select a project directory via a directory selection dialog.</p>"))
        self.mainscriptButton.setToolTip(_translate("PropertiesDialog", "Show file selection dialog"))
