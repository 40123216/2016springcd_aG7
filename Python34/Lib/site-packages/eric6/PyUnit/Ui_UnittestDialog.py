...
class Ui_UnittestDialog(object):
    ...
    def retranslateUi(self, UnittestDialog):
        ...
        self.testsuiteComboBox.setToolTip(_translate("UnittestDialog", "Enter name of file defining the testsuite"))
...
"cases.</p>"))
        ...
        self.fileDialogButton.setToolTip(_translate("UnittestDialog", "Open a file selection dialog"))
