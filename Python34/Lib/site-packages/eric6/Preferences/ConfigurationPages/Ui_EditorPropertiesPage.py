...
class Ui_EditorPropertiesPage(object):
    def setupUi(self, EditorPropertiesPage):
        ...
        EditorPropertiesPage.resize(558, 2611)
        self.verticalLayout = QtWidgets.QVBoxLayout(EditorPropertiesPage)
        ...
        self.verticalLayout.addWidget(self.coffeeScriptGroup)
        ...
        self.verticalLayout.addWidget(self.gettextGroup)
