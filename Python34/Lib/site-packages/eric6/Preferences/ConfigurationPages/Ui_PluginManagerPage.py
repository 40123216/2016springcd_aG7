...
class Ui_PluginManagerPage(object):
    def setupUi(self, PluginManagerPage):
        ...
        self.downloadDirEdit = QtWidgets.QLineEdit(PluginManagerPage)
        self.downloadDirEdit.setObjectName("downloadDirEdit")
        self.horizontalLayout_2.addWidget(self.downloadDirEdit)
        self.downloadDirButton = QtWidgets.QToolButton(PluginManagerPage)
        self.downloadDirButton.setObjectName("downloadDirButton")
        self.horizontalLayout_2.addWidget(self.downloadDirButton)
        ...
        self.gridLayout.addWidget(self.generationsSpinBox, 0, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.keepHiddenCheckBox, 1, 0, 1, 3)
        ...
        self._2 = QtWidgets.QHBoxLayout(self.groupBox_2)
        ...
        self._2.addWidget(self.noCheckRadioButton)
        ...
        self._2.addWidget(self.dailyCheckRadioButton)
        ...
        self._2.addWidget(self.weeklyCheckRadioButton)
        ...
        self._2.addWidget(self.monthlyCheckRadioButton)
        ...
        PluginManagerPage.setTabOrder(self.downloadDirButton, self.generationsSpinBox)
        PluginManagerPage.setTabOrder(self.generationsSpinBox, self.keepHiddenCheckBox)
        PluginManagerPage.setTabOrder(self.keepHiddenCheckBox, self.activateExternalPluginsCheckBox)
        PluginManagerPage.setTabOrder(self.activateExternalPluginsCheckBox, self.noCheckRadioButton)
        PluginManagerPage.setTabOrder(self.noCheckRadioButton, self.dailyCheckRadioButton)
    ...
    def retranslateUi(self, PluginManagerPage):
        ...
        self.downloadDirEdit.setToolTip(_translate("PluginManagerPage", "Enter the plugins download directory"))
        self.downloadDirButton.setToolTip(_translate("PluginManagerPage", "Select the plugins download directory via a directory selection dialog"))
