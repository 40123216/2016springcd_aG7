...
class Ui_EditorSpellCheckingPage(object):
    def setupUi(self, EditorSpellCheckingPage):
        ...
        self.pwlButton = QtWidgets.QToolButton(self.groupBox)
        self.pwlButton.setObjectName("pwlButton")
        self.gridLayout.addWidget(self.pwlButton, 0, 2, 1, 1)
        self.pelButton = QtWidgets.QToolButton(self.groupBox)
    ...
    def retranslateUi(self, EditorSpellCheckingPage):
        ...
        self.pwlEdit.setToolTip(_translate("EditorSpellCheckingPage", "Enter the filename of the personal word list"))
        self.label_5.setText(_translate("EditorSpellCheckingPage", "Personal exclude list file:"))
        self.pelEdit.setToolTip(_translate("EditorSpellCheckingPage", "Enter the filename of the personal exclude list"))
        ...
        self.pwlButton.setToolTip(_translate("EditorSpellCheckingPage", "Select the personal word list file via a file selection dialog"))
        self.pelButton.setToolTip(_translate("EditorSpellCheckingPage", "Select the personal exclude list file via a file selection dialog"))
