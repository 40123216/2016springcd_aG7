...
class Ui_NetworkPage(object):
    def setupUi(self, NetworkPage):
        ...
        NetworkPage.resize(591, 789)
        self.verticalLayout_5 = QtWidgets.QVBoxLayout(NetworkPage)
        ...
        self.verticalLayout_5.addWidget(self.proxyGroup)
    ...
    def retranslateUi(self, NetworkPage):
        ...
        self.downloadDirEdit.setToolTip(_translate("NetworkPage", "Enter the download directory (leave empty to use the default location)"))
        self.downloadDirButton.setToolTip(_translate("NetworkPage", "Select the download directory via a directory selection dialog"))
        ...
        self.groupBox_3.setTitle(_translate("NetworkPage", "Download Manager Cleanup Policy"))
