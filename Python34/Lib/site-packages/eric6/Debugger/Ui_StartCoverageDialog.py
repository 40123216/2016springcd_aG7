...
class Ui_StartCoverageDialog(object):
    def setupUi(self, StartCoverageDialog):
        ...
        StartCoverageDialog.resize(488, 225)
        StartCoverageDialog.setSizeGripEnabled(True)
        self.gridLayout = QtWidgets.QGridLayout(StartCoverageDialog)
        ...
        self.workdirCombo = QtWidgets.QComboBox(StartCoverageDialog)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.workdirCombo.setSizeAdjustPolicy(QtWidgets.QComboBox.AdjustToMinimumContentsLengthWithIcon)
        ...
        self.dirButton = QtWidgets.QToolButton(StartCoverageDialog)
...
"<p>Enter the commandline parameters in this field.</p>"))
        ...
        self.workdirCombo.setToolTip(_translate("StartCoverageDialog", "Enter the working directory"))
...
"<p>Select this to erase the collected coverage information before the next coverage run.</p>"))
        ...
        self.dirButton.setToolTip(_translate("StartCoverageDialog", "Select directory using a directory selection dialog"))
