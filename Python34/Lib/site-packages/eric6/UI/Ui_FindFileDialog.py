...
class Ui_FindFileDialog(object):
    def setupUi(self, FindFileDialog):
        ...
        self.dirCombo = QtWidgets.QComboBox(self.groupBox_2)
        ...
        self.dirCombo.setInsertPolicy(QtWidgets.QComboBox.InsertAtTop)
        self.dirCombo.setSizeAdjustPolicy(QtWidgets.QComboBox.AdjustToMinimumContentsLength)
        self.dirCombo.setObjectName("dirCombo")
        self.horizontalLayout_4.addWidget(self.dirCombo)
        self.dirSelectButton = QtWidgets.QToolButton(self.groupBox_2)
        ...
        self.dirButton.toggled['bool'].connect(self.dirCombo.setEnabled)
        self.dirButton.toggled['bool'].connect(self.dirSelectButton.setEnabled)
    ...
    def retranslateUi(self, FindFileDialog):
        ...
        self.dirCombo.setToolTip(_translate("FindFileDialog", "Enter the directory to search in"))
        self.dirSelectButton.setToolTip(_translate("FindFileDialog", "Select the directory via a directory selection dialog"))
